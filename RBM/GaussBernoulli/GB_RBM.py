...
class GB_RBM:
   ...
   def randomize_weights_and_biases(self, value_range = 0.000001):
      """
   ...
   def sample_visible(self, hidden):
      ...
      return np.random.normal(np.dot(self.weights, hidden) - self.bias_visible, 1.0)
   ...
   def sample_hidden(self, visible):
      ...
      h_sample = [1.0 if random.random() < p else 0.0 for p in P_hidden.tolist()]
